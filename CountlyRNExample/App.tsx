  ...
  render() {
    return (
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        ...
        <Button
          onPress={this.eventWithSum}
          title="Event with Sum"
          color="#e0e0e0">
          {' '}
        </Button>
        <Button
          onPress={this.eventWithSegment}
          title="Event with Segment"
          color="#e0e0e0">
          {' '}
        </Button>
        <Button
          onPress={this.eventWithSumAndSegment}
          title="Even with Sum and Segment"
          color="#841584">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.timedEventWithSum}
          title="Timed events with Sum"
          color="#e0e0e0">
          {' '}
        </Button>
        <Button
          onPress={this.timedEventWithSegment}
          title="Timed events with Segment"
          color="#e0e0e0">
          {' '}
        </Button>
        <Button
          onPress={this.timedEventWithSumAndSegment}
          title="Timed events with Sum and Segment"
          color="#e0e0e0">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.onSendUserData}
          title="Send Users Data"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
        ...
        <Button
          onPress={this.userData_setProperty}
          title="UserData.setProperty"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_increment}
          title="UserData.increment"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_incrementBy}
          title="UserData.incrementBy"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_multiply}
          title="UserData.multiply"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_saveMax}
          title="UserData.saveMax"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_saveMin}
          title="UserData.saveMin"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_setOnce}
          title="UserData.setOnce"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_pushUniqueValue}
          title="UserData.pushUniqueValue"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_pushValue}
          title="UserData.pushValue"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.userData_pullValue}
          title="UserData.pullValue"
          color="#00b5ad">
          {' '}
        </Button>

        <Button
          onPress={this.onSetUserProperties}
          title="Set Users Properties"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.onSendUserDataBulk}
          title="Send Users Data Bulk"
          color="#00b5ad">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.disableLocation}
          title="Disable Location"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.showStarRating}
          title="Show Star Rating Model"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.presentRatingWidget}
          title="Show FeedBack Model"
          color="#00b5ad">
          {' '}
        </Button>
        <TextInput
        ...
        <Button
          ...
          onPress={this.presentRatingWidgetUsingEditBox}
          title="Show Feedback using EditBox"
          color="#00b5ad">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.eventSendThreshold}
          title="Set Event Threshold"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.setCustomCrashSegments}
          title="Set Custom Crash Segment"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.setCustomMetrics}
          title="Set Custom Metrics"
          color="#00b5ad">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.askForNotificationPermission}
          title="askForNotificationPermission"
          color="#00b5ad"
        />
        <Button
          onPress={this.changeDeviceId}
        ...
        <Button
          onPress={this.giveAllConsent}
          title="Give all Consent"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.removeAllConsent}
          title="Remove all Consent"
          color="#00b5ad">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.giveMultipleConsent}
          title="Give multiple consent"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.removeMultipleConsent}
          title="Remove multiple consent"
          color="#00b5ad">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.remoteConfigUpdate}
          title="Update Remote Config"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.updateRemoteConfigForKeysOnly}
          title="Update Remote Config with Keys Only"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.updateRemoteConfigExceptKeys}
          title="Update Remote Config Except Keys"
          color="#00b5ad">
          {' '}
        </Button>

        <Button
          onPress={this.getRemoteConfigValueForKeyBoolean}
          title="Boolean Test"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.getRemoteConfigValueForKeyFloat}
          title="Float Test"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.getRemoteConfigValueForKeyInteger}
          title="Integer Test"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.getRemoteConfigValueForKeyString}
          title="String Test"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.getRemoteConfigValueForKeyJSON}
          title="JSON Test"
          color="#00b5ad">
          {' '}
        </Button>
        <Button
          onPress={this.remoteConfigClearValues}
          title="Clear remote config cache"
          color="#00b5ad">
          {' '}
        </Button>
        ...
        <Button
          onPress={this.recordNetworkTraceSuccess}
          title="End Network Request Success"
          color="#1b1c1d">
          {' '}
        </Button>
        <Button
          onPress={this.recordNetworkTraceFailure}
          title="End Network Request Failure"
          color="#1b1c1d">
          {' '}
        </Button>
        <Text style={[{textAlign: 'center'}]}>APM Example Start</Text>
